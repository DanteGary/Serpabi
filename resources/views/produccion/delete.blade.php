        ...
        <form data-toggle="validator" action="/item-ajax/14" method="DELETE">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel">Eliminar Produccion Diaria</h4>
            </div>
            <div class="modal-body"> 
                <p>Desea eliminar la produccion?</p>
                <input type="text" name="descripcion" disabled>  
                             
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-danger crud-submit-produccion-delete">Eliminar</button>

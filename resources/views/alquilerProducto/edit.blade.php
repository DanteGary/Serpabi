            ...
            <div class="modal-body">
                  ...
                  <form data-toggle="validator" action="/item-ajax/14" method="put">
                     <div class="form-group">
                        <label class="control-label" for="costo_producto">Costo:</label>
                           <input type="number" name="costo_producto" class="form-control" data-error="costo_producto." required />
                     ...
                     <div class="form-group">
                        <button type="submit" class="btn btn-success crud-submit-alquilerProducto-edit">Guardar</button>
                     </div>
                  </form>

<div class="modal fade" id="create-egreso" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
              <h4 class="modal-title" id="myModalLabel">Registro Egreso</h4>
            </div>
            <div class="modal-body">
      
                    <form data-toggle="validator" action="{{ route('egresos.store') }}" method="POST">
                            {{ csrf_field() }}    
                      ...
                      <div class="form-group">
                          <button type="submit" class="btn egreso-submit btn-success">Submit</button>
                      </div>
                    </form>
            </div>
          </div>

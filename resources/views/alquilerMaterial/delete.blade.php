        ...
        <form data-toggle="validator" action="/item-ajax/14" method="DELETE">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel">Eliminar Alquiler de Material</h4>
            </div>
            <div class="modal-body"> 
                ...
                <input type="text" name="id" disabled>  
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-danger crud-submit-alquilerMaterial-delete">Eliminar</button>

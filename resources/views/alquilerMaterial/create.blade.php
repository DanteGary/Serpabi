<div class="modal fade bd-example-modal-lg" id="create-alquilerMaterial" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      ...
                      <div class="col-md-6 col-xs-12 col-lg-6">       
                          <div class="col-md-8 col-xs-8">
                            <div class="form-group">
                              ...
                              <select id="mySelectCli" class="form-controal selectpicker " data-live-search=("true") name="id_cliente" data-error="selccione Cargo" required>
                      ...
                      <div class="row">
                            <div class="col-md-3 col-xs-3">
                              <div class="form-group">
                                ...
                                <select id="mySelect" class="form-control selectpicker " data-live-search=("true") name="id_material" data-error="selccione Cargo" required>
                                      <option value="">Seleccione...</option>
                            ...
                            <div class="col-md-3 col-xs-3">
                              <div class="form-group">
                                    ...
                                    <span class="label label-warning" id="costo" name="costo_alquiler" >0</span>
                                    <div class="help-block with-errors"></div>
                              </div>
                            </div>
                            ...
                            <div class="col-md-3 col-xs-3">
                              <div class="form-group">
                                <button type="button" id="agregar" class="btn btn-primary" data-toggle="modal" data-target=""><i class="fa fa-plus-square"></i>Agregar</button></h1>
                              </div>
                            </div>
                      </div>
                    ...
                    <div class="row">
                      <form data-toggle="validator" action="{{ route('alquileresMateriales.store') }}" method="POST">
                        ...
                        <div class="table-responsive">
                          ...
                          <div class="form-group">
                            <button type="submit" class="btn add-submit btn-warning">Aceptar</button>
                          </div>
                      </form>
                    </div>
            </div>

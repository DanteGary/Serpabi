        ...
        <form data-toggle="validator" action="/item-ajax/14" method="DELETE">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel">Eliminar Ubicacion</h4>
            </div>
            <div class="modal-body"> 
                <p>Desea eliminar la ubicacion?</p>
                <input type="double" name="latitud" disabled>  
                <input type="double" name="longitud" disabled>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-danger crud-submit-ubicacion-delete">Eliminar</button>
